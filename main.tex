...
\subsection{Visualización de las aproximaciones}

Ademas, se implementaron variantes auxiliares de los tres métodos que también devuelven la sucesión de aproximaciones. La Figura \ref{fig:bonus-parte3} muestra un caso representativo de cada método. Los colores oscuros corresponden a las primeras aproximaciones y los colores claros a las últimas.

\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{figura_bonus_parte3.png}
\caption{Sucesión de aproximaciones para bisección, Newton y descenso por gradiente.}
\label{fig:bonus-parte3}
\end{figure}

En bisección se graficaron los 29 puntos medios generados en el intervalo $[-2,1]$. La sucesión termina cerca del máximo local $x=-1.782932473$. En Newton se incluyó el punto inicial y las seis aproximaciones posteriores. Desde $x_0=-1$ se observa el salto hacia la zona positiva y la convergencia al máximo $x=0.589531341$. En descenso por gradiente se incluyó el punto inicial y las 32 actualizaciones. Desde $x_0=4$ las aproximaciones avanzan hacia el mínimo local $x=1.407956578$.
